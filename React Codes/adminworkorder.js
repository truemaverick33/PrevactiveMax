...
useEffect(()=>{
		$.ajax({type:"POST",url:connstr+"/Backend/Select.php",data:{datafor:"wom4adm",uid:sessionStorage.getItem('userid')},success(data){
